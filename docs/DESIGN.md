...
> Design notes for **marketplace-rate-limited-worker** — a runnable python example that Consume marketplace jobs with separate concurrency and start-rate controls.
...
- **Feature code** — the actual task: marketplace-queue-worker.
